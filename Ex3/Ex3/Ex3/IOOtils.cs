...
namespace Ex3
{
    public class IOUtils
    {
        ...
        public static int SafeReadInteger(string message) //ввести число int
        {
            while (true)
            {
        ...
        public static double getResultDate()
        {

            while (true)
            {
                Console.WriteLine("Enter your first date: ");

                Console.WriteLine("Введите 1_0 дату в формате (DD.MM.YYYY) для 1 отрезка: ");
                DateTime date1_0 = SafeReadDate(null, null);

                Console.WriteLine("Введите 1_1 дату в формате (DD.MM.YYYY) для 1 отрезка: ");

                DateTime date1_1 = SafeReadDate(null, null);

                Console.WriteLine("Enter your second date: ");

                Console.WriteLine("Введите 2_0 дату в формате (DD.MM.YYYY) для 1 отрезка: ");
                DateTime date2_0 = SafeReadDate(null, null);

                Console.WriteLine("Введите 2_1 дату в формате (DD.MM.YYYY) для 1 отрезка: ");

                DateTime date2_1 = SafeReadDate(null, null);
                ...
                if (date1_1 >= date1_0)
                {
                    if (date2_1 >= date2_0)
                    {
                        ...
                        {
                            Console.WriteLine("Enter your second date again, it must be > 1 date: \n");
                        }
                    }
